...
c     ===========================================================================
      ...
      parameter(nmax=50,galmax=1000000) !nmax: maxium number of photometric points/filters
...
c     model libraries, parameters, etc.
      ...
      real*8 ldust(nmod),mstr1(nmod),logldust(nmod),lssfr(nmod),tform_yr(nmod),gamma_parameter(nmod),z_z0(nmod),m_1r(nmod),sfr_6(nmod),sfr_7(nmod),sfr_9(nmod),sfr_29(nmod),t_lastb(nmod),fb_6(nmod),fb_7(nmod),fb_8(nmod),fb_9(nmod),fb_29(nmod),age_m(nmod),age_r(nmod),l_ha(nmod),l_hb(nmod)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!vVVVvvvvvVVV
      real*8 sfr_9_min,sfr_9_max,dsfr_9
      real*8 sfr_29_min,sfr_29_max,dsfr_29
      real*8 t_lastb_min,t_lastb_max,dt_lastb
      real*8 fb_6_min,fb_6_max,dfb_6
      real*8 fb_7_min,fb_7_max,dfb_7
      real*8 fb_8_min,fb_8_max,dfb_8
      real*8 fb_9_min,fb_9_max,dfb_9
      real*8 fb_29_min,fb_29_max,dfb_29
      real*8 age_m_min,age_m_max,dage_m
      real*8 age_r_min,age_r_max,dage_r
      real*8 l_ha_min,l_ha_max,dl_ha
      real*8 l_hb_min,l_hb_max,dl_hb
      real*8 sfr_7_min,sfr_7_max,dsfr_7
      real*8 sfr_6_min,sfr_6_max,dsfr_6
      real*8 tform_yr_min,tform_yr_max,dtform_yr
      real*8 gamma_parameter_min,gamma_parameter_max,dgamma_parameter
      real*8 z_z0_min,z_z0_max,dz_z0
      real*8 m_1r_min,m_1r_max,dm_1r
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!^^^^^^^^^^^
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!vvvvvvvvv
      real*8 pct_tform_yr(5),pct_gamma_parameter(5),pct_z_z0(5)
      real*8 pct_m_1r(5),pct_sfr_6(5),pct_sfr_7(5)
      real*8 pct_sfr_9(5),pct_sfr_29(5),pct_t_lastb(5)
      real*8 pct_fb_6(5),pct_fb_7(5),pct_fb_8(5)
      real*8 pct_fb_9(5),pct_fb_29(5),pct_age_m(5)
      real*8 pct_age_r(5),pct_l_ha(5),pct_l_hb(5)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!vvvvvvv
      integer nbin_tform_yr,nbin_gamma_parameter,nbin_z_z0,nbin_m_1r,nbin_sfr_6,nbin_sfr_7
      integer nbin_t_lastb,nbin_fb_6,nbin_fb_7,nbin_fb_8,nbin_fb_9,nbin_fb_29,nbin_age_m
      integer nbin_age_r,nbin_l_ha,nbin_l_hb,nbin_sfr_9,nbin_sfr_29

      integer nbin_tform_yr2,nbin_gamma_parameter2,nbin_z_z02,nbin_m_1r2,nbin_sfr_62,nbin_sfr_72
      integer nbin_t_lastb2,nbin_fb_62,nbin_fb_72,nbin_fb_82,nbin_fb_92,nbin_fb_292,nbin_age_m2
      integer nbin_age_r2,nbin_l_ha2,nbin_l_hb2,nbin_sfr_92,nbin_sfr_292
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!^^^^^^^^^^
...
!!!!!!!!!!!!!!!!!!!!!!vvvvvvvvvvvvv
      ...
      real*8 tform_yr_hist(nbinmax1),gamma_parameter_hist(nbinmax1),z_z0_hist(nbinmax1),m_1r_hist(nbinmax1)
      real*8 sfr_6_hist(nbinmax1),sfr_7_hist(nbinmax1),sfr_9_hist(nbinmax1),sfr_29_hist(nbinmax1)
      real*8 t_lastb_hist(nbinmax1),fb_6_hist(nbinmax1),fb_7_hist(nbinmax1),fb_8_hist(nbinmax1)
      real*8 fb_9_hist(nbinmax1),fb_29_hist(nbinmax1),age_m_hist(nbinmax1)
      real*8 age_r_hist(nbinmax1),l_ha_hist(nbinmax1),l_hb_hist(nbinmax1)

      real*8 tform_yr_hist2(nbinmax2),gamma_parameter_hist2(nbinmax2),z_z0_hist2(nbinmax2),m_1r_hist2(nbinmax2)
      real*8 sfr_6_hist2(nbinmax2),sfr_7_hist2(nbinmax2),sfr_9_hist2(nbinmax2),sfr_29_hist2(nbinmax2)
      real*8 t_lastb_hist2(nbinmax2),fb_6_hist2(nbinmax2),fb_7_hist2(nbinmax2),fb_8_hist2(nbinmax2)
      real*8 fb_9_hist2(nbinmax2),fb_29_hist2(nbinmax2),age_m_hist2(nbinmax2)
      real*8 age_r_hist2(nbinmax2),l_ha_hist2(nbinmax2),l_hb_hist2(nbinmax2)


      real*8 ptform_yr(nbinmax1),pgamma_parameter(nbinmax1),pz_z0(nbinmax1),pm_1r(nbinmax1)
      real*8 psfr_6(nbinmax1),psfr_7(nbinmax1),psfr_9(nbinmax1),psfr_29(nbinmax1)
      real*8 pt_lastb(nbinmax1),pfb_6(nbinmax1),pfb_7(nbinmax1),pfb_8(nbinmax1)
      real*8 pfb_9(nbinmax1),pfb_29(nbinmax1),page_m(nbinmax1)
      real*8 page_r(nbinmax1),pl_ha(nbinmax1),pl_hb(nbinmax1)

      real*8 ptform_yr2(nbinmax2),pgamma_parameter2(nbinmax2),pz_z02(nbinmax2),pm_1r2(nbinmax2)
      real*8 psfr_62(nbinmax2),psfr_72(nbinmax2),psfr_92(nbinmax2),psfr_292(nbinmax2)
      real*8 pt_lastb2(nbinmax2),pfb_62(nbinmax2),pfb_72(nbinmax2),pfb_82(nbinmax2)
      real*8 pfb_92(nbinmax2),pfb_292(nbinmax2),page_m2(nbinmax2)
      real*8 page_r2(nbinmax2),pl_ha2(nbinmax2),pl_hb2(nbinmax2)
...
!!!!!!!!!!!!!!!!!!!!!!^^^^^^^^^^^^^^^
      ...
      real*8 i_mu(nmod),i_tauv(nmod),i_tvism(nmod),i_tform_yr(nmod),i_gamma_parameter(nmod),i_z_z0(nmod),i_m_1r(nmod),i_sfr_6(nmod),i_sfr_7(nmod),i_sfr_9(nmod),i_sfr_29(nmod),i_t_lastb(nmod),i_fb_6(nmod),i_fb_7(nmod),i_fb_8(nmod),i_fb_9(nmod),i_fb_29(nmod),i_age_m(nmod),i_age_r(nmod),i_l_ha(nmod),i_l_hb(nmod) !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!


!tform_yr(nmod),gamma_parameter(nmod),z_z0(nmod),m_1r(nmod),sfr_6(nmod),sfr_7(nmod),sfr_9(nmod),sfr_29(nmod),t_lastb(nmod),fb_6(nmod),fb_7(nmod),fb_8(nmod),fb_9(nmod),fb_29(nmod),age_m(nmod),age_r(nmod),l_ha(nmod),l_hb(nmod),
...
c     histogram parameters: min,max,bin width
      ...
      data sfr_min/-10./,sfr_max/0.005/,dsfr/0.005/
      data a_min/3./,a_max/8.0025/,da/0.005/
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!--------------------------------vvvvvvvvvvvvv
! minimum/maximums
      data sfr_9_min/-15./,sfr_9_max/-8.0005/,dsfr_9/0.007/
!sfr_9_min/0./,sfr_9_max/0.00000000009/,dsfr_9/0.00000000000009/
      data sfr_29_min/-15./,sfr_29_max/-8.0005/,dsfr_29/0.007/
!sfr_29_min/0./,sfr_29_max/0.00000000005/,dsfr_29/0.00000000000005/
      data t_lastb_min/4.5/,t_lastb_max/10.5005/,dt_lastb/0.006/
!1.4E+10/,dt_lastb/1.4E+7/
      data fb_6_min/0./,fb_6_max/0.0500005/,dfb_6/0.00005/
      data fb_7_min/0./,fb_7_max/0.4005/,dfb_7/0.0004/
      data fb_8_min/0./,fb_8_max/0.9005/,dfb_8/0.0009/
      data fb_9_min/-0.05/,fb_9_max/1.0005/,dfb_9/0.001/
      data fb_29_min/-0.05/,fb_29_max/1.0005/,dfb_29/0.001/
      data age_m_min/7./,age_m_max/10.5005/,dage_m/0.003/
!age_m_min/0./,age_m_max/1.3E+10/,dage_m/1.3E+7/
      data age_r_min/7./,age_r_max/10.5005/,dage_r/0.003/
!age_r_min/0./,age_r_max/1.3E+10/,dage_r/1.3E+7/
      data l_ha_min/0./,l_ha_max/2.0005/,dl_ha/0.002/
      data l_hb_min/0./,l_hb_max/0.7005/,dl_hb/0.0007/
      data sfr_7_min/-15./,sfr_7_max/-7.0005/,dsfr_7/0.008/
!sfr_7_min/0./,sfr_7_max/0.000000075/,dsfr_7/0.000000000075/
      data sfr_6_min/-15./,sfr_6_max/-7.0005/,dsfr_6/0.008/
!sfr_6_min/0./,sfr_6_max/0.00000008/,dsfr_6/0.00000000008/
      data tform_yr_min/7.6/,tform_yr_max/10.4006/,dtform_yr/0.003/
      data gamma_parameter_min/0./,gamma_parameter_max/1.0005/,dgamma_parameter/0.001/
      data z_z0_min/0.02/,z_z0_max/2.0001/,dz_z0/0.002/
      data m_1r_min/0./,m_1r_max/18.003/,dm_1r/0.02/
...
c     save parameters
      ...
      save mdust
      save tform_yr,gamma_parameter,z_z0,m_1r,sfr_6,sfr_7,sfr_9,sfr_29,t_lastb,fb_6,fb_7,fb_8,fb_9,fb_29,age_m,age_r,l_ha,l_hb
...
c     Relevant physical parameters
                  tform_yr(i_sfh)=dlog10(fprop_sfh(i_sfh,1))
                  gamma_parameter(i_sfh)=fprop_sfh(i_sfh,2)
                  z_z0(i_sfh)=fprop_sfh(i_sfh,3)
                  m_1r(i_sfh)=fprop_sfh(i_sfh,7)
                  sfr_6(i_sfh)=dlog10(fprop_sfh(i_sfh,8))
                  sfr_7(i_sfh)=dlog10(fprop_sfh(i_sfh,9))
                  sfr_9(i_sfh)=dlog10(fprop_sfh(i_sfh,11))
                  sfr_29(i_sfh)=dlog10(fprop_sfh(i_sfh,12))
                  t_lastb(i_sfh)=dlog10(fprop_sfh(i_sfh,13))
                  fb_6(i_sfh)=fprop_sfh(i_sfh,14)
                  fb_7(i_sfh)=fprop_sfh(i_sfh,15)
                  fb_8(i_sfh)=fprop_sfh(i_sfh,16)
                  fb_9(i_sfh)=fprop_sfh(i_sfh,17)
                  fb_29(i_sfh)=fprop_sfh(i_sfh,18)
                  age_m(i_sfh)=dlog10(fprop_sfh(i_sfh,19))
                  age_r(i_sfh)=dlog10(fprop_sfh(i_sfh,20))
                  l_ha(i_sfh)=fprop_sfh(i_sfh,23)
                  l_hb(i_sfh)=fprop_sfh(i_sfh,24)
...
c     ---------------------------------------------------------------------------
         ...
         call get_histgrid(dtform_yr,tform_yr_min,tform_yr_max,nbin_tform_yr,tform_yr_hist)
         call get_histgrid(dgamma_parameter,gamma_parameter_min,gamma_parameter_max,nbin_gamma_parameter,gamma_parameter_hist)
         call get_histgrid(dz_z0,z_z0_min,z_z0_max,nbin_z_z0,z_z0_hist)
         call get_histgrid(dm_1r,m_1r_min,m_1r_max,nbin_m_1r,m_1r_hist)
         call get_histgrid(dsfr_6,sfr_6_min,sfr_6_max,nbin_sfr_6,sfr_6_hist)
         call get_histgrid(dsfr_7,sfr_7_min,sfr_7_max,nbin_sfr_7,sfr_7_hist)
         call get_histgrid(dsfr_9,sfr_9_min,sfr_9_max,nbin_sfr_9,sfr_9_hist)
         call get_histgrid(dsfr_29,sfr_29_min,sfr_29_max,nbin_sfr_29,sfr_29_hist)
         call get_histgrid(dt_lastb,t_lastb_min,t_lastb_max,nbin_t_lastb,t_lastb_hist)
         call get_histgrid(dfb_6,fb_6_min,fb_6_max,nbin_fb_6,fb_6_hist)
         call get_histgrid(dfb_7,fb_7_min,fb_7_max,nbin_fb_7,fb_7_hist)
         call get_histgrid(dfb_8,fb_8_min,fb_8_max,nbin_fb_8,fb_8_hist)
         call get_histgrid(dfb_9,fb_9_min,fb_9_max,nbin_fb_9,fb_9_hist)
         call get_histgrid(dfb_29,fb_29_min,fb_29_max,nbin_fb_29,fb_29_hist)
         call get_histgrid(dage_m,age_m_min,age_m_max,nbin_age_m,age_m_hist)
         call get_histgrid(dage_r,age_r_min,age_r_max,nbin_age_r,age_r_hist)
         call get_histgrid(dl_ha,l_ha_min,l_ha_max,nbin_l_ha,l_ha_hist)
         call get_histgrid(dl_hb,l_hb_min,l_hb_max,nbin_l_hb,l_hb_hist)
...
c     [makes code faster -- implemented by the Nottingham people]
         do i_sfh=1, n_sfh
            ...
            aux=((tform_yr(i_sfh)-tform_yr_min)/(tform_yr_max-tform_yr_min)) * nbin_tform_yr
            i_tform_yr(i_sfh) = 1 + dint(aux)

            aux=((gamma_parameter(i_sfh)-gamma_parameter_min)/(gamma_parameter_max-gamma_parameter_min)) * nbin_gamma_parameter
            i_gamma_parameter(i_sfh) = 1 + dint(aux)

            aux=((z_z0(i_sfh)-z_z0_min)/(z_z0_max-z_z0_min)) * nbin_z_z0
            i_z_z0(i_sfh) = 1 + dint(aux)

            aux=((m_1r(i_sfh)-m_1r_min)/(m_1r_max-m_1r_min)) * nbin_m_1r
            i_m_1r(i_sfh) = 1 + dint(aux)

            aux=((sfr_6(i_sfh)-sfr_6_min)/(sfr_6_max-sfr_6_min)) * nbin_sfr_6
            i_sfr_6(i_sfh) = 1 + dint(aux)

            aux=((sfr_7(i_sfh)-sfr_7_min)/(sfr_7_max-sfr_7_min)) * nbin_sfr_7
            i_sfr_7(i_sfh) = 1 + dint(aux)

            aux=((sfr_9(i_sfh)-sfr_9_min)/(sfr_9_max-sfr_9_min)) * nbin_sfr_9
            i_sfr_9(i_sfh) = 1 + dint(aux)

            aux=((sfr_29(i_sfh)-sfr_29_min)/(sfr_29_max-sfr_29_min)) * nbin_sfr_29
            i_sfr_29(i_sfh) = 1 + dint(aux)

            aux=((t_lastb(i_sfh)-t_lastb_min)/(t_lastb_max-t_lastb_min)) * nbin_t_lastb
            i_t_lastb(i_sfh) = 1 + dint(aux)

            aux=((fb_6(i_sfh)-fb_6_min)/(fb_6_max-fb_6_min)) * nbin_fb_6
            i_fb_6(i_sfh) = 1 + dint(aux)

            aux=((fb_7(i_sfh)-fb_7_min)/(fb_7_max-fb_7_min)) * nbin_fb_7
            i_fb_7(i_sfh) = 1 + dint(aux)

            aux=((fb_8(i_sfh)-fb_8_min)/(fb_8_max-fb_8_min)) * nbin_fb_8
            i_fb_8(i_sfh) = 1 + dint(aux)

            aux=((fb_9(i_sfh)-fb_9_min)/(fb_9_max-fb_9_min)) * nbin_fb_9
            i_fb_9(i_sfh) = 1 + dint(aux)

            aux=((fb_29(i_sfh)-fb_29_min)/(fb_29_max-fb_29_min)) * nbin_fb_29
            i_fb_29(i_sfh) = 1 + dint(aux)

            aux=((age_m(i_sfh)-age_m_min)/(age_m_max-age_m_min)) * nbin_age_m
            i_age_m(i_sfh) = 1 + dint(aux)

            aux=((age_r(i_sfh)-age_r_min)/(age_r_max-age_r_min)) * nbin_age_r
            i_age_r(i_sfh) = 1 + dint(aux)

            aux=((l_ha(i_sfh)-l_ha_min)/(l_ha_max-l_ha_min)) * nbin_l_ha
            i_l_ha(i_sfh) = 1 + dint(aux)

            aux=((l_hb(i_sfh)-l_hb_min)/(l_hb_max-l_hb_min)) * nbin_l_hb
            i_l_hb(i_sfh) = 1 + dint(aux)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!vvvvvvvvvvvvvvv
                  ...
                  ibin= i_z_z0(i_sfh)
                  ibin = max(1,min(ibin,nbin_z_z0))
                  pz_z0(ibin)=pz_z0(ibin)+prob

                  ibin= i_gamma_parameter(i_sfh)
                  ibin = max(1,min(ibin,nbin_gamma_parameter))
                  pgamma_parameter(ibin)=pgamma_parameter(ibin)+prob

                  ibin= i_tform_yr(i_sfh)
                  ibin = max(1,min(ibin,nbin_tform_yr))
                  ptform_yr(ibin)=ptform_yr(ibin)+prob

                  ibin= i_m_1r(i_sfh)
                  ibin = max(1,min(ibin,nbin_m_1r))
                  pm_1r(ibin)=pm_1r(ibin)+prob

                  ibin= i_sfr_6(i_sfh)
                  ibin = max(1,min(ibin,nbin_sfr_6))
                  psfr_6(ibin)=psfr_6(ibin)+prob

                  ibin= i_sfr_7(i_sfh)
                  ibin = max(1,min(ibin,nbin_sfr_7))
                  psfr_7(ibin)=psfr_7(ibin)+prob

                  ibin= i_sfr_9(i_sfh)
                  ibin = max(1,min(ibin,nbin_sfr_9))
                  psfr_9(ibin)=psfr_9(ibin)+prob

                  ibin= i_sfr_29(i_sfh)
                  ibin = max(1,min(ibin,nbin_sfr_29))
                  psfr_29(ibin)=psfr_29(ibin)+prob

                  ibin= i_t_lastb(i_sfh)
                  ibin = max(1,min(ibin,nbin_t_lastb))
                  pt_lastb(ibin)=pt_lastb(ibin)+prob

                  ibin= i_fb_6(i_sfh)
                  ibin = max(1,min(ibin,nbin_fb_6))
                  pfb_6(ibin)=pfb_6(ibin)+prob

                  ibin= i_fb_7(i_sfh)
                  ibin = max(1,min(ibin,nbin_fb_7))
                  pfb_7(ibin)=pfb_7(ibin)+prob

                  ibin= i_fb_8(i_sfh)
                  ibin = max(1,min(ibin,nbin_fb_8))
                  pfb_8(ibin)=pfb_8(ibin)+prob

                  ibin= i_fb_9(i_sfh)
                  ibin = max(1,min(ibin,nbin_fb_9))
                  pfb_9(ibin)=pfb_9(ibin)+prob

                  ibin= i_fb_29(i_sfh)
                  ibin = max(1,min(ibin,nbin_fb_29))
                  pfb_29(ibin)=pfb_29(ibin)+prob 

                  ibin= i_age_m(i_sfh)
                  ibin = max(1,min(ibin,nbin_age_m))
                  page_m(ibin)=page_m(ibin)+prob 

                  ibin= i_age_r(i_sfh)
                  ibin = max(1,min(ibin,nbin_age_r))
                  page_r(ibin)=page_r(ibin)+prob 

                  ibin= i_l_ha(i_sfh)
                  ibin = max(1,min(ibin,nbin_l_ha))
                  pl_ha(ibin)=pl_ha(ibin)+prob 

                  ibin= i_l_hb(i_sfh)
                  ibin = max(1,min(ibin,nbin_l_hb))
                  pl_hb(ibin)=pl_hb(ibin)+prob 
...
c     ---------------------------------------------------------------------------
         do i=1,1500
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!vvvvvvvvvvvvvvvvvv
            ptform_yr(i)=ptform_yr(i)/ptot
            pgamma_parameter(i)=pgamma_parameter(i)/ptot
            pz_z0(i)=pz_z0(i)/ptot
            pm_1r(i)=pm_1r(i)/ptot
            psfr_6(i)=psfr_6(i)/ptot
            psfr_7(i)=psfr_7(i)/ptot
            psfr_9(i)=psfr_9(i)/ptot
            psfr_29(i)=psfr_29(i)/ptot
            pt_lastb(i)=pt_lastb(i)/ptot
            pfb_6(i)=pfb_6(i)/ptot
            pfb_7(i)=pfb_7(i)/ptot
            pfb_8(i)=pfb_8(i)/ptot
            pfb_9(i)=pfb_9(i)/ptot
            pfb_29(i)=pfb_29(i)/ptot
            page_m(i)=page_m(i)/ptot
            page_r(i)=page_r(i)/ptot
            pl_ha(i)=pl_ha(i)/ptot
            pl_hb(i)=pl_hb(i)/ptot
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!^^^^^^^^^^^^^^^^^
            psfh(i)=psfh(i)/ptot
            pir(i)=pir(i)/ptot
            pmu(i)=pmu(i)/ptot
...
!!!!!!!!!!!!!!!!!!!vvvvvvvvvv
         ...
         call get_percentiles(nbin_tform_yr,tform_yr_hist,ptform_yr,pct_tform_yr)
         call get_percentiles(nbin_gamma_parameter,gamma_parameter_hist,pgamma_parameter,pct_gamma_parameter)
         call get_percentiles(nbin_z_z0,z_z0_hist,pz_z0,pct_z_z0)
         call get_percentiles(nbin_m_1r,m_1r_hist,pm_1r,pct_m_1r)
         call get_percentiles(nbin_sfr_6,sfr_6_hist,psfr_6,pct_sfr_6)
         call get_percentiles(nbin_sfr_7,sfr_7_hist,psfr_7,pct_sfr_7)
         call get_percentiles(nbin_sfr_9,sfr_9_hist,psfr_9,pct_sfr_9)
         call get_percentiles(nbin_sfr_29,sfr_29_hist,psfr_29,pct_sfr_29)
         call get_percentiles(nbin_sfr_29,sfr_29_hist,psfr_29,pct_sfr_29)
         call get_percentiles(nbin_t_lastb,t_lastb_hist,pt_lastb,pct_t_lastb)
         call get_percentiles(nbin_l_hb,l_hb_hist,pl_hb,pct_l_hb)
         call get_percentiles(nbin_l_ha,l_ha_hist,pl_ha,pct_l_ha)
         call get_percentiles(nbin_fb_6,fb_6_hist,pfb_6,pct_fb_6)
         call get_percentiles(nbin_fb_7,fb_7_hist,pfb_7,pct_fb_7)
         call get_percentiles(nbin_fb_8,fb_8_hist,pfb_8,pct_fb_8)
         call get_percentiles(nbin_fb_9,fb_9_hist,pfb_9,pct_fb_9)
         call get_percentiles(nbin_fb_29,fb_29_hist,pfb_29,pct_fb_29)
         call get_percentiles(nbin_age_m,age_m_hist,page_m,pct_age_m)
         call get_percentiles(nbin_age_r,age_r_hist,page_r,pct_age_r)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!vVVVVVVVVVVVVVVVVVVVVV
         call degrade_hist(dtform_yr,tform_yr_min,tform_yr_max,nbin_tform_yr,nbin_tform_yr2,tform_yr_hist,tform_yr_hist2,ptform_yr,ptform_yr2)
         call degrade_hist(dgamma_parameter,gamma_parameter_min,gamma_parameter_max,nbin_gamma_parameter,nbin_gamma_parameter2,gamma_parameter_hist,gamma_parameter_hist2,pgamma_parameter,pgamma_parameter2)
         call degrade_hist(dz_z0,z_z0_min,z_z0_max,nbin_z_z0,nbin_z_z02,z_z0_hist,z_z0_hist2,pz_z0,pz_z02)
         call degrade_hist(dm_1r,m_1r_min,m_1r_max,nbin_m_1r,nbin_m_1r2,m_1r_hist,m_1r_hist2,pm_1r,pm_1r2)
         call degrade_hist(dsfr_6,sfr_6_min,sfr_6_max,nbin_sfr_6,nbin_sfr_62,sfr_6_hist,sfr_6_hist2,psfr_6,psfr_62)
         call degrade_hist(dsfr_7,sfr_7_min,sfr_7_max,nbin_sfr_7,nbin_sfr_72,sfr_7_hist,sfr_7_hist2,psfr_7,psfr_72)
         call degrade_hist(dsfr_9,sfr_9_min,sfr_9_max,nbin_sfr_9,nbin_sfr_92,sfr_9_hist,sfr_9_hist2,psfr_9,psfr_92)
         call degrade_hist(dsfr_29,sfr_29_min,sfr_29_max,nbin_sfr_29,nbin_sfr_292,sfr_29_hist,sfr_29_hist2,psfr_29,psfr_292)
         call degrade_hist(dt_lastb,t_lastb_min,t_lastb_max,nbin_t_lastb,nbin_t_lastb2,t_lastb_hist,t_lastb_hist2,pt_lastb,pt_lastb2)
         call degrade_hist(dfb_6,fb_6_min,fb_6_max,nbin_fb_6,nbin_fb_62,fb_6_hist,fb_6_hist2,pfb_6,pfb_62)
         call degrade_hist(dfb_7,fb_7_min,fb_7_max,nbin_fb_7,nbin_fb_72,fb_7_hist,fb_7_hist2,pfb_7,pfb_72)
         call degrade_hist(dfb_8,fb_8_min,fb_8_max,nbin_fb_8,nbin_fb_82,fb_8_hist,fb_8_hist2,pfb_8,pfb_82)
         call degrade_hist(dfb_9,fb_9_min,fb_9_max,nbin_fb_9,nbin_fb_92,fb_9_hist,fb_9_hist2,pfb_9,pfb_92)
         call degrade_hist(dfb_29,fb_29_min,fb_29_max,nbin_fb_29,nbin_fb_292,fb_29_hist,fb_29_hist2,pfb_29,pfb_292)
         call degrade_hist(dage_m,age_m_min,age_m_max,nbin_age_m,nbin_age_m2,age_m_hist,age_m_hist2,page_m,page_m2)
         call degrade_hist(dage_r,age_r_min,age_r_max,nbin_age_r,nbin_age_r2,age_r_hist,age_r_hist2,page_r,page_r2)
         call degrade_hist(dl_ha,l_ha_min,l_ha_max,nbin_l_ha,nbin_l_ha2,l_ha_hist,l_ha_hist2,pl_ha,pl_ha2)
         call degrade_hist(dl_hb,l_hb_min,l_hb_max,nbin_l_hb,nbin_l_hb2,l_hb_hist,l_hb_hist2,pl_hb,pl_hb2)
...
c     ---------------------------------------------------------------------------
 ...
 703     format('#')
         ...
         write(31,800)
 800     format('# ... Results: a,fmu,tform_yr,gamma_parameter,z_z0,m_1r,sfr_6,sfr_7,sfr_9,sfr_29,t_lastb,fb_6,fb_7,fb_8,fb_9,fb_29,age_m,age_r,l_ha,l_hb.....')
 ...
 803     format(0p4f10.3,1p3e12.3,0p2f10.1,0p5f10.3,1p2e12.3)
	...
	write(31,*) a_sav,fmu_sfh(sfh_sav),tform_yr(sfh_sav),gamma_parameter(sfh_sav),z_z0(sfh_sav),m_1r(sfh_sav),sfr_6(sfh_sav),sfr_7(sfh_sav),sfr_9(sfh_sav),sfr_29(sfh_sav),t_lastb(sfh_sav),fb_6(sfh_sav),fb_7(sfh_sav),fb_8(sfh_sav),fb_9(sfh_sav),fb_29(sfh_sav),age_m(sfh_sav),age_r(sfh_sav),l_ha(sfh_sav),l_hb(sfh_sav)
         write(31,804)
 804     format('# BEST FIT MODEL: (i_sfh, i_ir, chi2, redshift, a, fmu)')
...
! 888     format('# ... M(dust)...')
!         do ibin=1,nbin2_md
!            write(31,807) indx(sfh_sav),ir_sav,a_sav,fmu_sfh(sfh_sav),redshift(i_gal)
!         enddo
!         write(31,60)
!         write(31,61) (pct_md(k),k=1,5)

	write(*,*) indx(sfh_sav),ir_sav,a_sav,fmu_sfh(sfh_sav),redshift(i_gal)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!vvvvvvvvvvvvvvv
         ...
         write(31,838)
 838     format('# ... tform_yr ...')
         do ibin=1,nbin_tform_yr2
            write(31,812) tform_yr_hist2(ibin),ptform_yr2(ibin)
         enddo
         write(31,60)
         write(31,62) (pct_tform_yr(k),k=1,5)

         write(31,837)
 837     format('# ... gamma_parameter ...')
         do ibin=1,nbin_gamma_parameter2
            write(31,812) gamma_parameter_hist2(ibin),pgamma_parameter2(ibin)
         enddo
         write(31,60)
         write(31,62) (pct_gamma_parameter(k),k=1,5)

         write(31,836)
 836     format('# ... z_z0 ...')
         do ibin=1,nbin_z_z02
            write(31,812) z_z0_hist2(ibin),pz_z02(ibin)
         enddo
         write(31,60)
         write(31,62) (pct_z_z0(k),k=1,5)

         write(31,835)
 835     format('# ... m_1r ...')
         do ibin=1,nbin_m_1r2
            write(31,812) m_1r_hist2(ibin),pm_1r2(ibin)
         enddo
         write(31,60)
         write(31,62) (pct_m_1r(k),k=1,5)

         write(31,834)
 834     format('# ... sfr_6 ...')
         do ibin=1,nbin_sfr_62
            write(31,812) sfr_6_hist2(ibin),psfr_62(ibin)
         enddo
         write(31,60)
         write(31,62) (pct_sfr_6(k),k=1,5)

         write(31,833)
 833     format('# ... sfr_7 ...')
         do ibin=1,nbin_sfr_72
            write(31,812) sfr_7_hist2(ibin),psfr_72(ibin)
         enddo
         write(31,60)
         write(31,62) (pct_sfr_7(k),k=1,5)

         write(31,832)
 832     format('# ... sfr_9 ...')
         do ibin=1,nbin_sfr_92
            write(31,812) sfr_9_hist2(ibin),psfr_92(ibin)
         enddo
         write(31,60)
         write(31,62) (pct_sfr_9(k),k=1,5)

         write(31,831)
 831     format('# ... sfr_29 ...')
         do ibin=1,nbin_sfr_292
            write(31,812) sfr_29_hist2(ibin),psfr_292(ibin)
         enddo
         write(31,60)
         write(31,62) (pct_sfr_29(k),k=1,5)

         write(31,830)
 830     format('# ... t_lastb ...')
         do ibin=1,nbin_t_lastb2
            write(31,812) t_lastb_hist2(ibin),pt_lastb2(ibin)
         enddo
         write(31,60)
         write(31,62) (pct_t_lastb(k),k=1,5)

         write(31,829)
 829     format('# ... fb_6 ...')
         do ibin=1,nbin_fb_62
            write(31,812) fb_6_hist2(ibin),pfb_62(ibin)
         enddo
         write(31,60)
         write(31,62) (pct_fb_6(k),k=1,5)

         write(31,828)
 828     format('# ... fb_7 ...')
         do ibin=1,nbin_fb_72
            write(31,812) fb_7_hist2(ibin),pfb_72(ibin)
         enddo
         write(31,60)
         write(31,62) (pct_fb_7(k),k=1,5)

         write(31,827)
 827     format('# ... fb_8 ...')
         do ibin=1,nbin_fb_82
            write(31,812) fb_8_hist2(ibin),pfb_82(ibin)
         enddo
         write(31,60)
         write(31,62) (pct_fb_8(k),k=1,5)

         write(31,826)
 826     format('# ...fb_9  ...')
         do ibin=1,nbin_fb_92
            write(31,812) fb_9_hist2(ibin),pfb_92(ibin)
         enddo
         write(31,60)
         write(31,62) (pct_fb_9(k),k=1,5)

         write(31,825)
 825     format('# ... fb_29 ...')
         do ibin=1,nbin_fb_292
            write(31,812) fb_29_hist2(ibin),pfb_292(ibin)
         enddo
         write(31,60)
         write(31,62) (pct_fb_29(k),k=1,5)

         write(31,824)
 824     format('# ... age_m ...')
         do ibin=1,nbin_age_m2
            write(31,812) age_m_hist2(ibin),page_m2(ibin)
         enddo
         write(31,60)
         write(31,62) (pct_age_m(k),k=1,5)

         write(31,823)
 823     format('# ... age_r ...')
         do ibin=1,nbin_age_r2
            write(31,812) age_r_hist2(ibin),page_r2(ibin)
         enddo
         write(31,60)
         write(31,62) (pct_age_r(k),k=1,5)

         write(31,822)
 822     format('# ...l_ha  ...')
         do ibin=1,nbin_l_ha2
            write(31,812) l_ha_hist2(ibin),pl_ha2(ibin)
         enddo
         write(31,60)
         write(31,62) (pct_l_ha(k),k=1,5)

         write(31,821)
 821     format('# ... l_hb ...')
         do ibin=1,nbin_l_hb2
            write(31,812) l_hb_hist2(ibin),pl_hb2(ibin)
         enddo
         write(31,60)
         write(31,62) (pct_l_hb(k),k=1,5)
